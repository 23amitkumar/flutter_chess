...
List<List<int>> calculateRawValidMoves(int row, int col,
  ...
  var selectedWhitePiece = selectedPiece?.isWhite??false;
  int direction = selectedWhitePiece ? -1 : 1;
  ...
  switch (selectedPiece!.type) {
    ...
    case ChessPieceType.pawn:
      ...
      if ((selectedWhitePiece && row == 6) ||
          (!selectedWhitePiece && row == 1)) {
      ...
      if (isInBoard(row + direction, col + 1) &&
          ...
          board[row + direction][col + 1]!.isWhite != selectedWhitePiece) {
      ...
      for (var direction in rookDirection) {
        ...
        while (true) {
          ...
          if (board[nextRow][nextCol] != null) {
            ...
            if (board[nextRow][nextCol]!.isWhite != selectedWhitePiece) {
